...
t1=Time(int(input("Enter hours for time 1 : ")),int(input("Enter minutes for time 1 : ")),int(input("Enter seconds for time 1 : ")))
t2=Time(int(input("Enter hours for time 2 : ")),int(input("Enter minutes for time 2 : ")),int(input("Enter seconds for time 2 : ")))
print("Time 1 : ")
t1.display()
print("Time 2 : ")
t2.display()
